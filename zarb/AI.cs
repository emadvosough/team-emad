...
namespace Game
{
    public class Max
    {
        ...
        public Max(Int64[] arr, ref int direct, int side)//to choose the best way
        {
            Int64 max = arr[0];
    ...
    public class AI : RealtimeAI<World, KSObject>
    {
        ...
        public override void Decide()
        {
            ...
            Int64[] direct = new Int64[] { 1, 1, 1, 1 };
            ...
            Int64 help = 1;//for sending to way function;
            ...
            Max a = new Max(direct, ref path,side);
            ...
            a = new Max(direct, ref path,side);
